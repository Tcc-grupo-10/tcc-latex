...
Sócrates é um homem; Todos os homens são mortais; Portanto, Sócrates é mortal." Isto segue as "Leis do pensamento" \cite{laws_of_thought}
	...
	\subsection*{Unsupervised Learning}
		Em Unsupervised learning, o sistema deve ser capaz de extrair um padrão dos dados por conta própria, sem nenhum tipo de mapeamento prévio. Apesar de ter aplicações bem sucedidas com esse método, ele é mais difícil de entender e avaliar. Exemplos de tarefas de Unsupervised Learning \cite {guido_muller}: 
	\begin{itemize}
	...
	\subsection*{Reinforcement Learning}
		No Reinforcement learning, o objetivo é desenvolver um sistema que melhora seu desempenho com base em interações com o ambiente (feedbacks). A diferença entre ele e o supervised learning, é o fato de que o feedback não é o valor correto, mas uma medida de quão bem a ação foi medida por uma função de recompensa. Através da interação com o ambiente, um agente pode usar o aprendizado de reforço para aprender uma série de ações que maximizam essa recompensa por meio de uma abordagem de tentativa e erro. \cite{ r_julian_heart}
